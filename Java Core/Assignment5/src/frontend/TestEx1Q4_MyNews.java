...
import entity.Ex1Q4_News;

public class TestEx1Q4_MyNews {
	List<Ex1Q4_News> cacNews = new ArrayList<Ex1Q4_News>();
	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in);
		List<Ex1Q4_News> cacNews = new ArrayList<Ex1Q4_News>();
		Ex1Q4_News myNews = new Ex1Q4_News();
